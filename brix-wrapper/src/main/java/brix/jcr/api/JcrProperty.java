...
public interface JcrProperty extends JcrItem
{
     ...
     * <code>{@link #setValue(Value value)}</code> except that the value is specified as a
     * <code>Binary</code>.
     * 
     * @param value
     *            The new value to set the property to.
     * @throws ValueFormatException
     *             if the type or format of the specified value is incompatible with the type of
     *             this property.
     * @throws VersionException
     *             if this property belongs to a node that is read-only due to a checked-in node and
     *             this implementation performs this validation immediately.
     * @throws LockException
     *             if a lock prevents the setting of the value and this implementation performs this
    ...
    /**
     * Returns a <code>BigDecimal</code> representation of the value of this property. A shortcut
     * for <code>Property.getValue().getDecimal()</code>.
     * 
     * @return A <code>BigDecimal</code> representation of the value of this property.
     * @throws ValueFormatException
     *             if conversion to a <code>BigDecimal</code> is not possible or if the property is
     *             multi-valued.
     * @throws RepositoryException
     *             if another error occurs
     * @see Value
    ...
    public BigDecimal getDecimal() ;
     ...
     /**
     * If this property is of type <code>PATH</code> (or convertible to this type) this method
     * returns the <code>Property</code> to which <i>this</i> property refers.
     * <p>
     * If this property contains a relative path, it is interpreted relative to the parent node of
     * this property. Therefore, when resolving such a relative path, the segment "<code>.</code>"
     * refers to the parent node itself, "<code>..</code>" to the parent of the parent node and "
     * <code>foo</code>" to a sibling property of this property or this property itself.
     * <p>
     * For example, if this property is located at <code>/a/b/c</code> and it has a value of "
     * <code>../d</code>" then this method will return the property at <code>/a/d</code> if such
     * exists.
     * <p>
     ...
     * <p>
     * If this property is currently part of the frozen state of a version in version storage, this
     * method will throw a <code>ValueFormatException</code>.
     * 
     * @return the referenced property
     * @throws ValueFormatException
     *             if this property cannot be converted to a <code>PATH</code>, if the property is
     ...
     *             If no property accessible by the current <code>Session</code> exists in this
