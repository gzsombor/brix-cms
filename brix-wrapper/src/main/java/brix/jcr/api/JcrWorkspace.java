...
public interface JcrWorkspace
{
    ...
    /**
     * Creates a new <code>Workspace</code> with the specified <code>name</code>. The new workspace
     * is empty, meaning it contains only root node.
     * <p>
     * The new workspace can be accessed through a <code>login</code> specifying its name.
     * 
     * @param name
     *            A <code>String</code>, the name of the new workspace.
     * @throws AccessDeniedException
     *             if the session through which this <code>Workspace</code> object was acquired does
    ...
    /**
     * Creates a new <code>Workspace</code> with the specified <code>name</code> initialized with a
     * <code>clone</code> of the content of the workspace <code>srcWorkspace</code>. Semantically,
     * this method is equivalent to creating a new workspace and manually cloning
     * <code>srcWorkspace</code> to it; however, this method may assist some implementations in
     * optimizing subsequent <code>Node.update</code> and <code>Node.merge</code> calls between the
     ...
     * @throws AccessDeniedException
     *             if the session through which this <code>Workspace</code> object was acquired does
     *             not have sufficient access to create the new workspace.
     * @throws UnsupportedRepositoryOperationException
     *             if the repository does not support the creation of workspaces.
     * @throws NoSuchWorkspaceException
     *             is <code>srcWorkspace</code> does not exist.
     * @throws RepositoryException
     *             if another error occurs.
     * @since JCR 2.0
     */
    ...
    /**
     * Deletes the workspace with the specified <code>name</code> from the repository, deleting all
     * content within it.
     * 
     * @param name
     *            A <code>String</code>, the name of the workspace to be deleted.
     * @throws AccessDeniedException
     *             if the session through which this <code>Workspace</code> object was acquired does
     *             not have sufficent access to remove the workspace.
     * @throws UnsupportedRepositoryOperationException
